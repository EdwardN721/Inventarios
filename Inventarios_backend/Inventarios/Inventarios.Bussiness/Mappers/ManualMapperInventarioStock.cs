...
public static class ManualMapperInventarioStock
{
    ...
    public static InventarioStock ToInventarioStock(InventarioStockRequestDto inventarioStockRequestDto)
    {
    ...
    public static void ToUpdateInventarioStock(InventarioStock inventarioStockExistente,
    ...
    public static InventarioStockResponseDto ToInventarioStockResponse(InventarioStock inventarioStock)
    {
    ...
    public static IEnumerable<InventarioStockResponseDto> ToInventarioStockResponse(
        IEnumerable<InventarioStock> inventarioStocks)
    {
        return inventarioStocks.Select(ToInventarioStockResponse);
    }
}